...
DEFAULT_SETTINGS = DefaultTestSettings(
    ...
    SUBJECT_SCREENING_MODEL=f"edc_adherence.subjectscreening",
    SUBJECT_CONSENT_MODEL=f"edc_adherence.subjectconsent",
    SUBJECT_VISIT_MODEL=f"edc_adherence.subjectvisit",
    SUBJECT_VISIT_MISSED_MODEL=f"edc_adherence.subjectvisitmissed",
    SUBJECT_REQUISITION_MODEL=f"edc_adherence.subjectrequisition",
